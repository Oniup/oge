...
//
// struct LayoutData {
//     yaml::Node* layout_names = nullptr;
...
//         yaml::Node& node, const std::string* path, PreferencesEditorPopup* preferences
//     )
//         : PreferencesMenuBase("GUI and Layout", path, node, preferences) {
//         m_layout_data.layout_names = &node["saved_layouts"];
//
//         if (m_layout_data.layout_names == nullptr) {
//             ogl::Debug::log(
//                 "Failed to retreave saved layout names in preferences.yaml", ogl::DebugType_Error
//             );
//         }
//     }
//
